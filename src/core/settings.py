...
AWS_QUICKSIGHT_NAMESPACE = config('AWS_QUICKSIGHT_NAMESPACE', cast=str, default='default')
AWS_QUICKSIGHT_ALLOWED_DOMAINS = config('AWS_QUICKSIGHT_ALLOWED_DOMAINS', cast=str, default=None)